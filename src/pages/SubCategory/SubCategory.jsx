...
const CategorySub = () => {
  ...
  const getCategory = async () => {
    let catresult = await fetch(config.apiurl + "/subcategory/");
  ...
  const handleCatsubmit = async () => {
    ...
    let methodapi = "";
    if (updateid) {
      apicaturl = config.apiurl + "/subcategory/" + updateid;
      methodapi = "put";
    } else {
      apicaturl = config.apiurl + "/subcategory/create";
      methodapi = "post";
    }
  ...
  const getSubcategory = async (editid) => {
    let subcateditdetails = await fetch(
      config.apiurl + "/subcategory/subcat/" + editid,
      {
        method: "get",
        headers: {
          Authorization: "bearer " + accesstoken.data.access_token,
